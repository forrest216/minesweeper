...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_userVariable":["macro",3],
      "vtp_ordinalType":"UNIQUE",
      "vtp_transactionVariable":["macro",4],
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","allowLinker","value","false"],["map","fieldName","title","value",["macro",7]],["map","fieldName","userId","value",["macro",8]]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
      "vtp_dimension":["list",["map","index","1","dimension",["macro",9]],["map","index","2","dimension",["macro",10]],["map","index","3","dimension",["macro",11]],["map","index","4","dimension",["macro",12]],["map","index","5","dimension",["macro",13]],["map","index","6","dimension",["macro",14]],["map","index","7","dimension",["macro",15]]],
      "vtp_enableEcommerce":false,
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","allowLinker","value","false"],["map","fieldName","page","value",["macro",17]],["map","fieldName","title","value",["macro",18]],["map","fieldName","userId","value",["macro",8]]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
  ...
  "rules":[
    ...
    [["if",1],["add",11,14,18]],
    [["if",1,14],["add",16]],
    [["if",1,2],["block",0,1,4,5,6,7,8,12,13,14,15,18]]]
},
"runtime":[
[],[]
]
...
V.a.j=["google"],function(){(function(a){V.__j=a;V.__j.g="j";V.__j.h=!0;V.__j.b=0})(function(a){for(var b=String(a.vtp_name).split("."),c=K(b.shift()),d=0;d<b.length;d++)c=c&&c[b[d]];return c})}();
...
c.vtp_gtmOnFailure()},c.vtp_gtmOnFailure));var v=K("dataLayer"),x=v&&v.hide;x&&x.end&&(x[c.vtp_optimizeContainerId]=!0)}else z(c.vtp_gtmOnFailure)};V.__opt=b;V.__opt.g="opt";V.__opt.h=!0;V.__opt.b=0}();
...
V.a.cegg=["nonGoogleScripts"],function(){var a={};(function(b){V.__cegg=b;V.__cegg.g="cegg";V.__cegg.h=!0;V.__cegg.b=0})(function(b){try{var c=b.vtp_usersNumericId;if(c)if(a.hasOwnProperty(c)&&!0===a[c])b.vtp_gtmOnSuccess();else{b.vtp_snapshotName&&(f.CE_SNAPSHOT_NAME=b.vtp_snapshotName);for(var d=c.toString();8>d.length;)d="0"+d;var e=d.replace(/(\d+)(\d{4})$/,"/pages/scripts/$1/$2.js");G("//script.crazyegg.com"+e+"?"+Math.floor((new Date).getTime()/36E5),b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure);a[c]=
...
h})};return{store:function(h,k){var l=g(h);l?l.button=k:e.push({form:h,button:k})},get:function(h){var k=g(h);return k?k.button:null}}}function d(e,g,h,k){var l=Jf("fsl",h?"nv.mwt":"mwt",0),m;m=h?Jf("fsl","nv.ids",[]):Jf("fsl","ids",[]);if(!m.length)return!0;var n=Ff(e,"gtm.formSubmit",m),p=e.action;p&&p.tagName&&(p=e.cloneNode(!1).action);n["gtm.elementUrl"]=p;if(k&&l){if(!zh(n,g,l))return!1}else zh(n,function(){},l||2E3);return!0}(function(e){V.__fsl=e;V.__fsl.g="fsl";V.__fsl.h=!0;V.__fsl.b=0})(function(e){var g=
e.vtp_waitForTags,h=e.vtp_checkValidation,k=Number(e.vtp_waitForTagsTimeout);if(!k||0>=k)k=2E3;var l=e.vtp_uniqueTriggerId||"0";if(g){var m=function(p){return Math.max(k,p)};If("fsl","mwt",m,0);h||If("fsl","nv.mwt",m,0)}var n=function(p){p.push(l);return p};If("fsl","ids",n,[]);h||If("fsl","nv.ids",n,[]);Gh("fsl")||(a(),Hh("fsl"));z(e.vtp_gtmOnSuccess)})}();
