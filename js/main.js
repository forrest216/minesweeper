var images = {
   ...
   'null': { w: 'url("images/null.png")', n: 'url("images/neonnull.jpeg")' },
   'X': { w: 'url("images/X.png")', n: 'url("images/eye.gif")' },
   'F': { w: 'url("images/F.png")', n: 'url("images/neonF.gif")' },
   '0': { w: 'url("images/0.png")', n: 'url("images/neon0.png")' },
   '1': { w: 'url("images/1.png")', n: 'url("images/neon1.png")' },
   '2': { w: 'url("images/2.png")', n: 'url("images/neon2.png")' },
   '3': { w: 'url("images/3.png")', n: 'url("images/neon3.png")' },
   '4': { w: 'url("images/4.png")', n: 'url("images/neon4.png")' },
   '5': { w: 'url("images/5.png")', n: 'url("images/neon5.png")' },
   '6': { w: 'url("images/6.png")', n: 'url("images/neon6.png")' },
   '7': { w: 'url("images/7.png")', n: 'url("images/neon7.png")' },
   '8': { w: 'url("images/8.png")', n: 'url("images/neon8.png")' },
}
